...
import com.naky.todoapp.utils.Constants.PREFERENCE_KEY
import com.naky.todoapp.utils.Constants.PREFERENCE_NAME
...
class DataStoreRepository @Inject constructor(
    ...
    val readDataStore : Flow<Any> = dataStore.data
        .catch {
            exception ->
